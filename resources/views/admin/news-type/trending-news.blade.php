...
@section('title') Trending News  @endsection
@section('doc-title') Trending News  @endsection
@section('add-css')
        ...
        <div class="card">
            <div class="card-body" id="addForm">
                <form  action="{{route('admin.news.news-type-store')}}" method="POST" id="formSubmit"  enctype="multipart/form-data" >
                    @csrf
                    <input name="type" value="trending" hidden>
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="mb-3">
                                <label>News</label>
                        ...
                        <div class="col-lg-12 d-flex justify-content-end mt-4">
                            <button type="submit" class="btn btn-primary w-md mx-2"><i class="fa fa-save"></i> Add To Trending News </button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Trending News ({{$trending_news->count()}})</h4>
                        <form class="ml-auto" action="{{route('admin.news.trending-news')}}" method="get">
                    ...
                    <div class="table-responsive">
                        @include('admin.news-type.table',['news_types'=>$trending_news])
                    </div>

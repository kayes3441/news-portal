...
@section('body')
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body" id="addForm">
                <h5 class="card-title text-primary mb-3">Sub Sub Category </h5>
                <form  action="{{route('admin.sub-sub-category.create')}}" method="POST" id="formSubmit"  enctype="multipart/form-data" >
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-xl-4 mb-2">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"style="width: 175px">Sub Sub Category Name</span>
                                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Sub Sub  Table</h4>
                    @include('admin.sub_sub_category.table')
                </div>
            </div>
        </div>
    </div>
...
@section('js')@include('admin.sub_sub_category.script')@endsection

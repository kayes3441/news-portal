            ...
            <div class="row">
                    ...
                    <div class="bg-light mb-3" style="padding: 30px;">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <p class="m-0">Dhanmondi 27 ,Dhaka,Bangladesh</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-3">
                ...
                <div class="col-md-7">
                    <div class="contact-form bg-light mb-3" style="padding: 30px;">
                        <div id="success"></div>
                        <form action="{{route('message-store')}}" method="post" novalidate="novalidate">
                            @csrf
                            <div class="form-row">
                                <div class="col-md-6">
                            ...
                            <div class="control-group">
                                <input type="text" class="form-control p-4" subject="subject" placeholder="Subject" required="required" data-validation-required-message="Please enter a subject" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                            ...
                            <div>
                                <button type="submit" class="btn btn-primary font-weight-semi-bold px-4" style="height: 50px;" type="submit" id="sendMessageButton">Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
